...
// Define the Convergent Swarm Algorithm function
// export function convergentSwarmAlgorithm(grid, startNode, endNode) {
//   // Create a priority queue for node exploration
//   const priorityQueue = [];

//   // Set the initial distance of start node to 0
...
//       // Add the neighbor to the visited nodes array (including walls and weights)
