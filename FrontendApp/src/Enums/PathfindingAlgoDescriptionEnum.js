...
const PathfindingAlgoDescriptionExtraEnum = {
    ...
    GREEDY_BREADTH_FIRST_SEARCH: "Greedy Breadth-First Search is a variation of BFS that explores neighboring nodes with the smallest heuristic value first. This approach aims to reach the goal efficiently and is commonly used in heuristic search problems.",
